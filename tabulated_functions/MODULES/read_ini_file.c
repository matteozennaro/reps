...
void read_parameter_file(char parfile[])
{
  ...
  sprintf(param_names[2],"z0");
  sprintf(param_names[3],"z1");
  sprintf(param_names[4],"z_beta_in");
  sprintf(param_names[5],"z_fc_in");
  sprintf(param_names[6],"z_fn_in");
  sprintf(param_names[7],"output_number");
  sprintf(param_names[8],"z_output");
  sprintf(param_names[9],"h");
  sprintf(param_names[10],"OB0");
  sprintf(param_names[11],"OC0");
  sprintf(param_names[12],"OG0");
  sprintf(param_names[13],"M_nu");
  sprintf(param_names[14],"do_rescaled_ps");
  sprintf(param_names[15],"As");
  sprintf(param_names[16],"ns");
  sprintf(param_names[17],"tau_reio");
  sprintf(param_names[18],"kmax");
  sprintf(param_names[19],"N_nu");
  sprintf(param_names[20],"Neff");
  sprintf(param_names[21],"print_hubble");
  sprintf(param_names[22],"boltzmann_folder");
  sprintf(param_names[23],"ps_norm_at_z");
  sprintf(param_names[24],"normfile");
  sprintf(param_names[25],"wrong_nu");
  sprintf(param_names[26],"boltzmann_code");
  sprintf(param_names[27],"w0");
  sprintf(param_names[28],"wa");
  ...
  printf("  %s = %lf\n",param_names[2],z0);
  printf("  %s = %lf\t\t",param_names[3],z1);
  printf("  %s = %lf\n",param_names[4],z_beta_in);
  printf("  %s = %lf\t\t",param_names[5],z_fc_in);
  printf("  %s = %lf\n",param_names[6],z_fn_in);
  printf("  %s = %i\n",param_names[7],output_number);
  printf("  %s =",param_names[8]);
  for (i=0; i<output_number; i++)
    printf(" %.2lf",z_output[i]); printf("\n");
  printf("  %s = %lf\t\t\t",param_names[9],h);
  printf("  %s = %lf\n",param_names[10],OB0);
  printf("  %s = %lf\t\t",param_names[11],OC0);
  printf("  %s = %e\n","OR0",OR0);
  printf("  %s = %lf\t\t",param_names[13],M_nu);
  printf("  %s = %e\n",param_names[15],As);
  printf("  %s = %lf\t\t\t",param_names[16],ns);
  printf("  %s = %lf\n",param_names[17],tau_reio);
  printf("  %s = %c\n",param_names[14],do_rescaled_ps);
